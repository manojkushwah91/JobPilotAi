...
import com.jobpilot.domain.identity.EmailVerificationTokenId;
...
public class EmailVerificationTokenEntity extends BaseJpaEntity {
    ...
    public static EmailVerificationTokenEntity fromDomain(EmailVerificationToken domain) {
    ...
    public EmailVerificationToken toDomain() {
        return EmailVerificationToken.reconstitute(
            EmailVerificationTokenId.from(id),
            userId,
            token,
            expiresAt,
            used,
