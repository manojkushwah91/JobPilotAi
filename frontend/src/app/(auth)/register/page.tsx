  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>Enter your details to get started with JobPilot AI</CardDescription>
      </CardHeader>
