...
import { User, Loader2, Plus, X, Sparkles } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-mesh p-6">
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-medium text-primary">Profile Setup</span>
            </div>
            <h1 className="text-3xl font-bold tracking-tight mb-1">Settings</h1>
            <p className="text-muted-foreground">Configure your profile for AI-powered applications</p>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[240px_1fr]">
          ...
          <div className="space-y-4">
            <div className="skeleton-premium h-48 w-full rounded-xl" />
            <div className="skeleton-premium h-32 w-full rounded-xl" />
            <div className="skeleton-premium h-32 w-full rounded-xl" />
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="glass-strong animate-fade-in">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => saveBasic.mutate({ fullName: form.fullName, phone: form.phone, location: form.location, headline: form.headline, summary: form.summary })} disabled={saveBasic.isPending} className="gap-2 bg-gradient-primary hover:opacity-90">
          ...
          <Card className="glass-strong animate-fade-in" style={{ animationDelay: '50ms' }}>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => saveSkills.mutate({ skills: form.skills })} disabled={saveSkills.isPending} className="gap-2 bg-gradient-primary hover:opacity-90">
          ...
          <Card className="glass-strong animate-fade-in" style={{ animationDelay: '100ms' }}>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => saveExperience.mutate({ experience: form.experience })} disabled={saveExperience.isPending} className="gap-2 bg-gradient-primary hover:opacity-90">
          ...
          {/* Education */}
          <Card className="glass-strong animate-fade-in" style={{ animationDelay: '150ms' }}>
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => saveEducation.mutate({ education: form.education })} disabled={saveEducation.isPending} className="gap-2 bg-gradient-primary hover:opacity-90">
          ...
          {/* Resume Text */}
          <Card className="glass-strong animate-fade-in" style={{ animationDelay: '200ms' }}>
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => saveBasic.mutate({ resumeText: form.resumeText })} disabled={saveBasic.isPending} className="gap-2 bg-gradient-primary hover:opacity-90">
          ...
          {/* Job Preferences */}
          <Card className="glass-strong animate-fade-in" style={{ animationDelay: '250ms' }}>
            <CardHeader>
